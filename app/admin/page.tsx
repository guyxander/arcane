...
export default async function Admin() {
  ...
  if (!auth) return <main className="portal-page"><div className="auth-card"><h1>CRM setup required</h1><p>Connect Supabase environment variables to activate Google authentication and the Arcane CRM.</p></div></main>;
